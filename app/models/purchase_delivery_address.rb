class PurchaseDeliveryAddress
  ...
  attr_accessor :postal_code, :city, :block, :building_name, :phone_number, :item_id, :user_id, :delivery_source_id
  ...
  def save
    ...
    DeliveryAddress.create(postal_code: postal_code, city: city, block: block, building_name: building_name, phone_number: phone_number, purchase_id: purchase.id, delivery_source_id: delivery_source_id)
  end
end